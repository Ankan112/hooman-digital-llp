                ...
                <div className="hero">
                    <div className="hero-content px-0 py-10 flex-col lg:flex-row">
                        <div className="text-center lg:text-left">
                            <h2 className='text-3xl md:text-6xl text-white font-bold'>Crafted by creatives, <br /> <span style={{ color: '#000F5F' }}>for creative</span></h2>
                            ...
                            <button style={{ backgroundColor: '#000F5F' }} className='mt-14 text-white font-bold text-2xl py-4 px-8'>Know More</button>
                        </div>
