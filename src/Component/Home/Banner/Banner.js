                ...
                <div className="hero">
                    <div className="flex justify-between items-center px-0 flex-col lg:flex-row">
                        <div className="text-left md:w-1/2">
                            ...
                            <h2 className='text-4xl md:text-7xl text-white font-bold'>Elevate Your Online Presence </h2>

                            <p className='text-xl md:text-4xl mt-10 text-white font-semibold'>At Hooman Digital, we specialize in delivering powerful and effective services that enhances your business’s online presence, making it more robust and impactful.</p>
                            <div className='flex md:flex-row'>
                                <button style={{ backgroundColor: '#000F5F' }} className='mt-6 md:mt-14 text-white font-bold text-lg md:text-3xl py-4 px-8'>Get Started</button>

                                <button style={{ backgroundColor: '#000F5F' }} className='mt-6 md:mt-14 text-white font-bold text-lg md:text-3xl py-4 px-8 ml-7 md:ml-10'>See Pricing</button>
                            </div>
                        </div>
